	...
	public function get_tags() {
		...
		$email_tags = array(
			...
			array(
				...
				'description' => esc_html__( 'Display the login page url as plain text, e.g. for use in a link or button.', 'wp-user-manager' ),
				'tag'         => 'login_page_url',
				'function'    => 'wpum_email_tag_login_page_url',
			),
			array(
				'name'        => esc_html__( 'Login page link', 'wp-user-manager' ),
				'description' => esc_html__( 'Display a link to the login page.', 'wp-user-manager' ),
				'tag'         => 'login_page_link',
				'function'    => 'wpum_email_tag_login_page_link',
			),
			array(
				'name'        => esc_html__( 'Password recovery url', 'wp-user-manager' ),
				'description' => esc_html__( 'Display the password recovery url as plain text, e.g. for use in a link or button.', 'wp-user-manager' ),
				'tag'         => 'recovery_url',
				'function'    => 'wpum_email_tag_password_recovery_url',
			),
			array(
				'name'        => esc_html__( 'Password recovery link', 'wp-user-manager' ),
				'description' => esc_html__( 'Display a link to the password recovery page.', 'wp-user-manager' ),
				'tag'         => 'recovery_link',
