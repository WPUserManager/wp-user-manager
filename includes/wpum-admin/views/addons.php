<div class="wrap" id="wpum-addons-page">
	<h1>
		<?php esc_html_e( 'WP User Manager Add-ons' ); ?>
		<a href="https://wpusermanager.com/addons/" class="button-primary" target="_blank">
			<?php esc_html_e( 'View All Add-ons' ); ?><span class="dashicons dashicons-external"></span>
		</a>
	</h1>

	<p><?php esc_html_e( 'The following Add-ons extend the functionality of WP User Manager.' ); ?></p>
		...
		<?php foreach( $this->get_addons() as $addon ) : ?>
			...
			<div class="download type-download">
				...
				<div class="addon-footer-wrap give-clearfix">
					<a href="<?php echo esc_url( $addon->link ); ?>" title="<?php echo esc_html( $addon->title ); ?>" class="button" target="_blank"><?php echo esc_html__( 'Read more' ); ?> <span class="dashicons dashicons-external"></span></a>
				</div>
			</div>
