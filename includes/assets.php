...
function wpum_enqueue_scripts() {
	...
	$prefix = defined( 'WPUM_VUE_DEV' ) && WPUM_VUE_DEV ? '' : '.min';
	...
	wp_enqueue_script( 'wpum-frontend-js', WPUM_PLUGIN_URL . 'assets/js/wp-user-manager'.$prefix.'.js', array( 'jquery' ), WPUM_VERSION, true );
