...
add_action( 'wp_ajax_nopriv_wpum_upload_image', 'wpum_upload_image' );
add_action( 'wp_ajax_nopriv_wpum_load_image', 'wpum_load_image' );
add_action( 'wp_ajax_nopriv_wpum_delete_image', 'wpum_delete_image' );
